...
<body>
	...
	<br>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="hidden" name="category" value="jewellery"></td>
							</tr>
						</table>
					</center>
				</div>
		...
		<?php
			if (isset($_POST['add']))
				...
				header ("location:admin_jewellery.php");
			}}
		}
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Jewellery</h2></center></div>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					$query = mysqli_query($conn, "SELECT * FROM `product` WHERE category='jewellery' ORDER BY product_id DESC") or die(mysqli_error());
