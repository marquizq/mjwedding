...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="text" name="product_size" placeholder="Size" style="width:250px;" maxLength="255" required></td>
							</tr>
							<tr>
							...
							<tr>
								<td><input type="hidden" name="category" value="dresses"></td>
							</tr>
						</table>
					</center>
				</div>
		...
		<ul>
			...
			<li><a href="admin_home.php">Products</a>
				<ul>
					...
					<li><a href="admin_jewellery.php "style="font-size:15px; margin-left:15px;">Jewellery</a></li>
					<li><a href="admin_shoes.php" style="font-size:15px; margin-left:15px;">Shoes</a></li>
					<li><a href="admin_flowers.php"style="font-size:15px; margin-left:15px;">Flowers</a></li>
					<li><a href="admin_dresses.php"style="font-size:15px; margin-left:15px;">Dresses</a></li>
				</ul>
			</li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Dresses</h2></center></div>
			<br />
		...
		<div class="alert alert-info">
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					$query = mysqli_query($conn, "SELECT * FROM `product` WHERE category='Dresses' ORDER BY product_id DESC") or die(mysqli_error());
