...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="hidden" name="category" value="shoes"></td>
							</tr>
						</table>
					</center>
				</div>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Shoes</h2></center></div>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					$query = mysqli_query($conn, "SELECT * FROM `product` WHERE category='shoes' ORDER BY product_id DESC") or die(mysqli_error());
