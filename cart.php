<?php
	...
	$result=mysqli_query($conn, "Update product SET product_size=$prod_size WHERE product_id=$id");
...
if (isset($_SESSION['cart']))
	...
	$total=$total+$line_cost;
		...
		echo "<td><strong><h3>Tsh. ".$line_cost."</h3></strong>";
		echo "</tr>";
		}
		...
		echo "<td><strong><input type='hidden' value='".$total."' required name='total'><h2 class='text-danger'>Tsh. ".$total."</h2></strong></td>";
		echo "<td></td>";
